    ...
    return (
        <Layout>
            ...
            <main>
                <h1>{title}</h1>
                <ul>
                    {results?.map((result: { section: any; display_name: string | number | boolean | ReactElement<any, string | JSXElementConstructor<any>> | ReactFragment | ReactPortal | null | undefined; }) => {
                        return(
                            <>
